...
public class Testmain {
	...
	public static void main(String[] args){
		...
		LoadTimeSeries t=gen.generateLoadTimeSeries( df.parseDateTime("01.01.2012"), df.parseDateTime("31.12.2012"));
		...
		LoadTimeSeries real=gen.generateLoadTimeSeries( df.parseDateTime("01.01.2013"), df.parseDateTime("31.12.2013"));
